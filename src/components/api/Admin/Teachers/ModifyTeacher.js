...
const ModifyTeacher = ({ teacher, showModal, handleClose, handleUpdateTeacherInfo }) => {
    const [form, setForm] = useState({
        name: teacher.name,
        firstLastName: teacher.first_last_name,
        secondLastName: teacher.second_last_name,
        semester: teacher.semester,
        career: teacher.career.career,
    });
