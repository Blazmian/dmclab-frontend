        ...
        const createAdmin = async () => {
            ...
            if (res.status === 201) {
                Swal.fire({
                    ...
                    text: '¡Ahora podrás disfrutar los beneficios de ser un administrador! Procede a iniciar sesión para comenzar',
                }).then(response => {
                    navigate('/')
                })
                    ...
                    <CDBBox display="flex" justifyContent="center" style={{ height: '100%' }} alignItems='center'>
                        <CDBBox>
                            <CDBBox display="flex" alignItems="center" className="mb-5">
                                ...
                                <h6 style={{ margin: '0' }}>Usted ha sido invitado a formar parte del grupo de administradores. Por favor, llene los siguientes datos para completar su registro</h6>
                            </CDBBox>
